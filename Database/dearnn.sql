...
CREATE TABLE IF NOT EXISTS `remote_user_cyberbullying_detection_type` (
  ...
  `cyberbullying_type` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `remote_user_cyberbullying_detection_type` (`id`, `tweet_test`, `cyberbulling_type`) VALUES
...
(64, 'Naive Bayes', '75.82555823461578'),
